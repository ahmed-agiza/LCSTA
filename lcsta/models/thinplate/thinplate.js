...
var TPS = function(){
  ...
  this.compile = function(cents, y_vals){
     ...
     if(!cents.every(function(element){
        ...
        throw 'centers must have same dimensions :/';
     }
     ...
     if(!ws){
       throw 'rbf failed to compile with given centers./nCenters must be unique :/';
     }
  ...
  this.getValues = function(pnts, cb){
     ...
     return {points: pnts, ys: resultArr};
